...
export const primaryColor = createSelector(themeColors, (colors: object) => get(colors, "primary"));

export const secondaryColor = createSelector(themeColors, (colors: object) =>
